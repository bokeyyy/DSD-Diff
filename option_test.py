...
parser.add_argument('--data_range', type=str, default='1-3450/1-5',
...
parser.add_argument('--sig', type=float, default=0.6,
...
parser.add_argument('--model', default='dsddiff',
                    help='model name')
...
parser.add_argument('--diff', type=str, default='off',
                    help='choose diff')
...
parser.add_argument('--epochs_encoder', type=int, default=400,
...
#                     help='do lr decay every N epochs(loss not down)')
# parser.add_argument('--decay_num', type=int, default=4,
#                     help='do N-1 lr decay')
# parser.add_argument('--lr_decay_max', type=int, default=150,
#                     help='learning rate decay max N epochs')
...
parser.add_argument('--lr_decay_encoder', type=int, default=100,
...
# Log specifications
parser.add_argument('--save', type=str, default='dsddiff',
